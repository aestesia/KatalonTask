...
WebUI.click(findTestObject('Object Repository/Aldo/ArticleNCourse/a_Masuk'))

'Klik Button Masuk dan ke Halaman Login'
WebUI.takeFullPageScreenshot()

//Input Data Login
WebUI.setText(findTestObject('Object Repository/Aldo/ArticleNCourse/input_email'), Email)
WebUI.setText(findTestObject('Object Repository/Aldo/ArticleNCourse/input_password'), Password)

'Input Email dan Password Pada Form Login, Lalu Klik Button Sign In'
WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Object Repository/Aldo/ArticleNCourse/button_Masuk'))
WebUI.delay(2)
...
WebUI.click(findTestObject('Object Repository/Aldo/ArticleNCourse/button_artikel'))
'Halaman Menu Artikel'
WebUI.takeFullPageScreenshot()

//Cek Headline
WebUI.click(findTestObject('Object Repository/Aldo/ArticleNCourse/klik_headline'))
...
WebUI.setText(findTestObject('Object Repository/Aldo/ArticleNCourse/subscribe_nama'), Nama2)
WebUI.setText(findTestObject('Object Repository/Aldo/ArticleNCourse/subscribe_email'), Email2)

'Isi Kolom Subscribe Artikel dan Klik Subscribe'
WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Object Repository/Aldo/ArticleNCourse/button_subscribe'))

//Cek Page Article
WebUI.navigateToUrl('https://metrodataacademy.id/article')


WebUI.click(findTestObject('Object Repository/Aldo/ArticleNCourse/page2'))
'Check Page 2 Artikel'
WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Object Repository/Aldo/ArticleNCourse/page3'))
'Check Page 3 Artikel'
WebUI.takeFullPageScreenshot()

//TC-2 Cek Menu Mengajar
WebUI.navigateToUrl('https://metrodataacademy.id/')
WebUI.click(findTestObject('Object Repository/Aldo/ArticleNCourse/button_mengajar'))
'Halaman Menu Mengajar'
WebUI.takeFullPageScreenshot()

//Daftar Mengajar
WebUI.click(findTestObject('Object Repository/Aldo/ArticleNCourse/daftar_mengajar'))
'Klik tombol Daftar untuk cek Detail'
WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Object Repository/Aldo/ArticleNCourse/klik_daftar'))
'Klik Daftar'
WebUI.takeFullPageScreenshot()

//Lihat Semua Course
WebUI.navigateToUrl('https://metrodataacademy.id/metrodata-mengajar')
WebUI.click(findTestObject('Object Repository/Aldo/ArticleNCourse/lihat_mengajar'))
...
//WebUI.takeScreenshot()
//
////String Validate_Email = WebUI.getText(findTestObject('Object Repository/Boy/Email'))
