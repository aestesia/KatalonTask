...
if (WebUI.verifyElementVisible(findTestObject('Object Repository/Boy/VerifyLihatProgram'))) {
...
WebUI.scrollToElement(findTestObject('Object Repository/Boy/Training/VerifyText'), 0)

WebUI.verifyElementVisible(findTestObject('Object Repository/Boy/Training/VerifyText'))
...
WebUI.click(findTestObject('Object Repository/Boy/Training/ViewAll'))
...
WebUI.click(findTestObject('Object Repository/Boy/Training/Metrodata Training'))
...
WebUI.click(findTestObject('Object Repository/Boy/Training/Metrodata IT Camp'))
...
WebUI.click(findTestObject('Object Repository/Boy/Training/Metrodata Mengajar'))
...
WebUI.click(findTestObject('Object Repository/Boy/Training/Metrodata Internship'))
...
WebUI.click(findTestObject('Object Repository/Boy/TentangKami/HomeMetro'))
